...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color: #333333; color: #ffffff;">{{ __('Inicio de Sesión') }}</div>

                    <div class="card-body" style="background-color: #383c44; color: #ffffff;">
